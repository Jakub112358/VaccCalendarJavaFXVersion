...
public class BaseScheme {
    ...
    private List<VaccineType> vaccinesList;
    ...
    public void addVaccine(VaccineType vaccineType){
        this.vaccinesList.add(vaccineType);
    }
    ...
    public List<VaccineType> getVaccinesList() {
        return vaccinesList;
    }
